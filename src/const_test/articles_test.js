...
{ 
    ...
    content_image : require("../img/PageOfArticles/femmes.png"),
...
{ 
    id:"L",
     avatar :require("../img/PageOfArticles/slate.png"),
    title:'slate.fr',
    subheader:"September 13, 2017",
    content_image : require("../img/PageOfArticles/agri.png"),
...
},
{
    id:"G",
    title:"Tunivisions ",
    avatar :require("../img/PageOfArticles/tuni.png"),
    subheader:"janvier 31, 2020",
    content_image : require("../img/PageOfArticles/arbre.png"),
...
},
{
    ...
    content_image : require("../img/PageOfArticles/n.png"),
...
{ 
    id:"M",
    title:'Jeune afrique',
    avatar :require('../img/PageOfArticles/jeune.png'),
    subheader:"September 13, 2019",
    content_image : require("../img/PageOfArticles/rea.png"),
...

{
    id:"A",
    title:"Tunis Webdo",
    avatar :require('../img/PageOfArticles/tuniswebdo.png'),
    subheader:"janvier 2, 2015",
    content_image : require("../img/PageOfArticles/vet.png"),
